...
\setbeamertemplate{footline}{
  ...
  \hbox{
    ...
    \begin{beamercolorbox}[wd=.5\paperwidth,ht=3ex,dp=1ex,left]{author in head/foot}
      %\hspace{0.8ex}\raisebox{-0.2ex}{\includegraphics[height=0.8cm]{logo.png}} % hr branding
      \hspace{0.8ex}{\includegraphics[height=0.5cm]{gw_logo.png}} % gwu branding
    \end{beamercolorbox}%
    % RIGHT: page number
...
\begin{itemize}
    \item \href{https://smhs.gwu.edu/academics/md-program/current-students/policies/ai-use-guidelines}{Guidelines for the Use of Artificial Intelligence (AI) for the MD Program}
\end{itemize}
