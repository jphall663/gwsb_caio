...
\section{Decision Making and Over Reliance}

%------------------------------------------------
\begin{frame}[t]{Chatbots — Avoid Over Reliance for Decision Making\\
\small{\parencite{TowardsaStandardforI537, ArtificialIntelligen058}}}
\textbf{Principle:} Fundementally, chatbots guess the next word \parencite{hicks2024chatgpt}. Don’t let chatbots replace your reasoning and judgment. But you can use them to augment your own thinking.
...
\vspace{1em}
Consider asking about how decisions are made about X: ``\texttt{Are there any well-known or accepted process for for deciding about X?}''\\ 
\vspace{1em}
...
\begin{itemize}
    ...
    \end{itemize}
    \item Chatbots drafts the outline into coherent text.
...
\begin{itemize}
    \item AI writes code; you write tests and documentation.
    \item You write code; AI writes tests and documentation.
    \item Have AI implement the same logic two different ways and verify matching outputs.\\
\end{itemize} 
\vspace{1em}
...
\begin{columns}[T]
    ...
    \vspace{1em}
    People can over-rely on reasoning when basic data analysis could lead to better decisions, e.g., the representativeness heuristic.
...
%------------------------------------------------
\begin{frame}[t]{Chatbots — How AI Differs from Human Thinking \parencite{bennett2023brief}}
\begin{itemize}
    \item Lacks a model of the physical world.
    \item Lacks a model of its own information processing.
    \begin{itemize}
        \item But do approximate via ``Chain-of-Thought'' (CoT) workflows \parencite{wei2022chain}.
    \end{itemize}
    \item Lacks emotion.
    \item Uses different sensory inputs (digital data vs. human senses).
